#!/bin/bash
#to run this script go into the folder where it is then run: ./install_godot3.sh
#
set -eu
#
folder_name="godotengine3"
#
...
Exec=/home/$USER/programs_setup/godotengine3/$thefile
Icon=/home/$USER/programs_setup/godotengine3/godot.svg
Terminal=false
Type=Application
